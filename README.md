...
### 🔧 Skills & Tools:
- **Frontend:** React, Next.js, JavaScript, Tailwind CSS, Motion, JSON, Zustand, Axios, React Router DOM, OAuth, JWT, REST/GraphQL, Session-based authentication, Postman
- **Backend:** Learning Node.js, API development, Django
